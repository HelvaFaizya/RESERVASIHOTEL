...
<div class="form-group">
    ...
    <select class="form-control" name="txtTipeKamar" autofocus>
     <option <?=$Kamar['tipe_kamar']=='standar'? 'selected':null;?> value="standar" >Standar Room</option>
     <option <?=$Kamar['tipe_kamar']=='single'? 'selected':null;?> value="single">Single Room</option>
     <option <?=$Kamar['tipe_kamar']=='twin'? 'selected':null;?> value="twin">Twin Room</option>
     <option <?=$Kamar['tipe_kamar']=='deluxe'? 'selected':null;?> value="deluxe">Deluxe Room</option>
     <option <?=$Kamar['tipe_kamar']=='suite'? 'selected':null;?> value="suite">Suite Room</option>
    </select>
