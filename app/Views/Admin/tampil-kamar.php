...
<p><?=$introText;?>
<p>
	<a href="<?=site_url('/tambah-kamar');?>" class="btn btn-success btn-sm font-weight-bold">Tambah Kamar</a>
</p>
    	...
    	<div class="col-md-3">
        	...
        	<div class="card-body"  style="min-height:150px">
            	<h5 class="card-title">Kamar <?=ucwords($row['tipe_kamar']);?></h5>
                	<p class="card-text">Harga : Rp.<?=number_format($row['harga_kamar'],0,',','.');?> /Malam</p>
                	<p>Fasilitas kamar :
                	<?php
