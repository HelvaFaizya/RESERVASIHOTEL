<!-- memanggil isi file dashbord.php di folder view/admin -->
<?=$this->extend('admin/dashboard');?>
<!--area putih halaman dashbord-->
<?=$this->section('konten');?>
<h2><?=$JudulHalaman;?></h2>
<?=$introText;?>
<p>
   <a href="<?=site_url('/tambah-fasilitas-hotel');?>" class="btn btn-success font-weight-bold">Tambah Fasilitas</a>
</p>
...
<div class="row">
	...
	<div class="col-md-3">
		...
		<div class="card-body">
			...
			<a href="<?=site_url('/edit-fasilitas-hotel/'.$row['id_fasilitas_hotel']);?>" class="btn btn-info btn-block btn-sm">Edit</a>
