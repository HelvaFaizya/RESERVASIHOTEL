...
<html lang="en">
  <head>
	...
	<!-- Bootstrap core CSS -->
<link href="/bootstrap/css/bootstrap.min11.css" rel="stylesheet">
  ...
  <body>
	  <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-info border-bottom shadow-lg">
		  <h5 class="my-2 mr-md-auto font-weight-normal">ROSEWOOD HOTEL</h5>
	...
	<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
		<h1 class="display-6"><?=isset($JudulHalaman) ? $JudulHalaman : 'ROSEWOOD HOTEL KUNINGAN';?></h1>
	...
	<div class="container">
		...
		if(isset($JudulHalaman)){
			...
			echo '<div class="card-deck mb-0 text-center">';
			if(isset($listKamar)){
				...
				<div class="card mb-2 shadow-sm">
					...
					<div class="card-body">
						<h1 class="card-title pricing-card-title">Rp. <?=number_format($row['harga_kamar'],0,',','.');?> <small class="text-muted">/Malam</small></h1>
						<ul class="list-unstyled mt-3 mb-4">
							...
							<a href="<?=site_url('/order/'.$row['id_kamar']);?>" class="btn btn-sm btn-block btn-outline-danger">Pesan Sekarang</a>
						</div>
					</div>
					<?php
					}
