...
$routes->post('/fasilitas-hotel','Fasilitashotel::index',['filter'=>'otentifikasi']);
...
$routes->post('/tampil-fasilitas-hotel','Fasilitashotel::index',['filter'=>'otentifikasi']);
...
//routes untuk mengelola menu fasilitas kamar
...
$routes->post('/tampil-fasilitas-kamar','Fasilitaskamar::index',['filter'=>'otentifikasi']);
...
//routes untuk mengelola menu kamar
...
//routes untuk mengelola halaman depan
$routes->get('/', 'Home::index');
...
//routes untuk mengelola Reservasi
